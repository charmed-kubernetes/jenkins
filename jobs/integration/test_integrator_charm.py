...
@pytest.mark.asyncio
def test_load_balancer(setup_storage_elb_resource):
    ...
    """
    sh.kubectl.run("hello-world",
                   replicas=5,
                   labels='run=load-balancer-example',
                   image="gcr.io/google-samples/node-hello:1.0",
                   port=8080)
    sh.kubectl.expose("deployment",
                      "hello-world",
                      type="LoadBalancer",
                      name="hello")
