...
@pytest.mark.parametrize("charm_name", ["kubernetes-control-plane", "kubernetes-worker"])
...
@pytest.mark.parametrize("charm_name", ("kubernetes-worker", "kubernetes-control-plane"))
