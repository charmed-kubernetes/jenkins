...
for sid in `aws --region us-east-2 ec2 describe-subnets --query Subnets[].SubnetId --output text`; do aws --region us-east-2 ec2 delete-tags --resources $sid --tags Value=owned; done
