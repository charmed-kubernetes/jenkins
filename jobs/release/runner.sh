...
prepare() {
    ...
    ci_lxc_apt_install_retry "$LXC_NAME" python3-pip python3-venv python3-dev libffi-dev git curl openssh-client redsocks nftables uuid-runtime jq libarchive-tools procps
